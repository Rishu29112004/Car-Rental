...
export const cityList = ["delhi", "pune", "bangalore", "chennai", "hyderabad"];
...
export const dummyCarData = [
  ...
  },
  {
    ...
    location: "New York",
    description:
      "The BMW X5 Sport is a premium luxury SUV offering powerful performance, advanced safety features, and a comfortable interior.",
    isAvailable: true,
  ...
  },
  {
    ...
    location: "Los Angeles",
    description:
      "Hyundai Verna SX is a stylish and fuel-efficient sedan known for its smooth ride, modern design, and reliable performance.",
    isAvailable: true,
